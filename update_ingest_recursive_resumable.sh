#!/usr/bin/env bash
# ============================================================
# Reescreve app/rag/ingest.py para suportar:
#   - busca recursiva em subpastas (rglob)
#   - processamento incremental arquivo-por-arquivo (baixo uso de RAM)
#   - estado retomavel (nao reprocessa arquivo ja indexado)
#   - --limit N para testar com poucos arquivos primeiro
#   - --exclude "substring" para pular subpastas indesejadas
# Uso: rodar dentro de ~/sap-integration-copilot
#   bash update_ingest_recursive_resumable.sh
# ============================================================
set -e
...
echo "app/rag/ingest.py atualizado (recursivo, incremental, retomavel)."
